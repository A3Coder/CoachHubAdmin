                    ...
                    <View style={styles.Section3_container}>
                        <View style={{ padding: 18, borderTopRightRadius: 30, borderTopLeftRadius: 30, }}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <View style={{ width: '48%' }}>
                                    ...
                                    <TextInput
                                        ...
                                        style={{ flex: 1, height: 50, fontSize: 15, fontWeight: 'bold', color: 'black', paddingHorizontal: 8, borderBottomWidth: 0.5, borderBottomColor: 'grey' }}>
                                    </TextInput>
                                    {
                                        datePicker && (<DateTimePicker weekDaysTextStyle={{ color: 'black' }} headerTextStyle={{ color: 'black' }} calendarTextStyle={{ color: 'black' }} selectedItemColor='#4477BB' mode="single" date={date} onChange={(params) => { setdate(new Date(params.date)) }} />)
                                    }
                                </View>
                            </View>
                            ...
                            <View style={{ marginTop: 15, width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 5, backgroundColor: '#4477BB' }}>
                                ...
                                <View style={{ width: '18%' }}>
                                    <Text style={{ textAlign: 'center', color: 'white' }}>Present</Text>
                                </View>
                                <View style={{ width: '18%' }}>
                                    <Text style={{ textAlign: 'center', color: 'white' }}>Absent</Text>
                                </View>
                            </View>
